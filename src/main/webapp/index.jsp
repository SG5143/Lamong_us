...
<body>
	<div class="container">
		...
		<div class="button-container">
			<button class="btn btn-main" data-modal="play-method-modal">플레이 방법</button>
			<div class="btn-group">
				<button class="btn btn-sub" data-modal="login-modal">로그인</button>
				<button class="btn btn-sub" data-modal="join-modal">회원가입</button>
			</div>
			<div class="btn-group">
				<button class="btn btn-sub" data-modal="find-id-modal">아이디 찾기</button>
				<button class="btn btn-sub" data-modal="find-pw-modal">비밀번호 찾기</button>
			</div>
		</div>
	</div>
